...
#set_property -dict {PACKAGE_PIN E3 IOSTANDARD LVCMOS33} [get_ports clk_25]
#create_clock -period 40.000 -name clk_25 -waveform {0.000 20.000} -add [get_ports clk_25]
