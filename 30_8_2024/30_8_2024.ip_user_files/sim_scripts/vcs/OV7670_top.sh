...
#
# Script generated by Vivado on Fri Aug 30 16:28:07 +0530 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : OV7670_top.sh
...
#
# Usage        : OV7670_top.sh
#                OV7670_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                OV7670_top.sh [-reset_run]
#                OV7670_top.sh [-reset_log]
#                OV7670_top.sh [-help]
#
...
#                script (type 'OV7670_top.sh -help' for more information).
#
...
# script info
echo -e "OV7670_top.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./OV7670_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../30_8_2024.gen/sources_1/ip/clock_wiz_25" \
  ...
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k +incdir+"../../../30_8_2024.gen/sources_1/ip/clock_wiz_25" \
  "../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../30_8_2024.gen/sources_1/ip/clock_wiz_25" \
  ...
  "../../../../../ankur/ sir/30_8_2024/30_8_2024.srcs/sources_1/imports/reff/I2C_Controller2.v" \
  "../../../../../ankur/ sir/30_8_2024/30_8_2024.srcs/sources_1/imports/reff/I2C_OV7670_RGB565_Config2.v" \
  "../../../../../ankur/ sir/30_8_2024/30_8_2024.srcs/sources_1/imports/reff/OV7670_init.v" \
  "../../../../../ankur/ sir/30_8_2024/30_8_2024.srcs/sources_1/imports/reff/ov7670_capture.v" \
  "../../../../../ankur/ sir/30_8_2024/30_8_2024.srcs/sources_1/imports/reff/vga.v" \
  "../../../../../ankur/ sir/30_8_2024/30_8_2024.srcs/sources_1/imports/reff/OV7670_top.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.OV7670_top xil_defaultlib.glbl -o OV7670_top_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./OV7670_top_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key OV7670_top_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc OV7670_top_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./OV7670_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: OV7670_top.sh [-help]\n\
Usage: OV7670_top.sh [-step]\n\
Usage: OV7670_top.sh [-lib_map_path]\n\
Usage: OV7670_top.sh [-reset_run]\n\
Usage: OV7670_top.sh [-reset_log]\n\
Usage: OV7670_top.sh [-keep_index]\n\
Usage: OV7670_top.sh [-noclean_files]\n\n\
