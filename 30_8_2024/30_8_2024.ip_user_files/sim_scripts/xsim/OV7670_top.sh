...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L blk_mem_gen_v8_4_8 -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot OV7670_top xil_defaultlib.OV7670_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim OV7670_top -key {Behavioral:sim_1:Functional:OV7670_top} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb OV7670_top.wdb xsim.dir libdpi.so)
