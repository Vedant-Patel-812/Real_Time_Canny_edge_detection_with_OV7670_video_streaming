...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../30_8_2024.gen/sources_1/ip/clock_wiz_25" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../30_8_2024.gen/sources_1/ip/clock_wiz_25" \
  "../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../30_8_2024.gen/sources_1/ip/clock_wiz_25" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.OV7670_top xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.OV7670_top -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log OV7670_top_sc.so .tmp_log xcelium_lib waves.shm c.obj)
